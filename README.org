...
#+BEGIN_EXAMPLE
wslclient [-w] [+line:column] file...  # for WSL
wslclient.exe [+line:column] file...   # no-wait version for Windows
wslclient-w.exe [+line:column] file... # wait version for Windows
