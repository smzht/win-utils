...
#+BEGIN_EXAMPLE
wslclient.exe [emacsclient options] file...         # no-wait version for Windows
wslclient-w.exe [emacsclient options] file...       # wait version for Windows
emacsclientw.exe [emacsclient options] file...      # emacsclient command with activate control
emacsclientw [-c] [-n] [-q]  [+line:column] file... # emacsclientw command for WSL
#+END_EXAMPLE
